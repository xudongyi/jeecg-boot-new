      ...
      <a-row>
        ...
        <a-col span='12'>
          <a-form-item label="数采仪编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['colletionNumber']" placeholder="请输入数采仪编号" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="生产厂家" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['factory']" placeholder="请输入生产厂家" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="生产日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <j-date placeholder="请选择生产日期" v-decorator="['prodcutDate']" :trigger-change="true" style="width: 100%" :disabled="disable"/>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="数采仪型号" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['productModel']" placeholder="请输入数采仪型号" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="ip地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['ip']" placeholder="请输入ip地址" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="安装日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <j-date placeholder="请选择安装日期" v-decorator="['installDate']" :trigger-change="true" style="width: 100%" :disabled="disable"/>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['concatUser']" placeholder="请输入联系人" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="联系电话" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['concatMobile', validatorRules.concatMobile]" placeholder="请输入联系电话" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="保质日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <j-date placeholder="请选择保质日期" v-decorator="['shelfLifeDate']" :trigger-change="true" style="width: 100%" :disabled="disable"/>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="运维单位" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['operationCompany']" placeholder="请输入运维单位" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="运维负责人" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['operationUser']" placeholder="请输入运维负责人" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="运维负责人电话" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['operationMobile', validatorRules.operationMobile]"
                     placeholder="请输入运维负责人电话" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="SIM卡号" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['sim']" placeholder="请输入SIM卡号" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='12'>
          <a-form-item label="使用协议" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <a-input v-decorator="['protocol']" placeholder="请输入使用协议" :disabled="disable"></a-input>
          </a-form-item>
        </a-col>
        <a-col span='12'>
          <a-form-item label="设备启用日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <j-date placeholder="请选择设备启用日期" v-decorator="['useDate']" :trigger-change="true" style="width: 100%" :disabled="disable"/>
          </a-form-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col span='24'>
          <a-form-item label="备注" :labelCol="labelCols" :wrapperCol="wrapperCols">
            <a-textarea v-decorator="['content']" rows="4" placeholder="请输入备注" :disabled="disable"/>
          </a-form-item>
        </a-col>
      </a-row>
