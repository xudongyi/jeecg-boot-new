...
<script>
  ...
  import CompanyRiskWasteModal from "./CompanyRiskWasteModal";
  import {getAction} from "../../../../../api/manage";

  export default {
    name: "CompanyRiskWasteList",
    mixins: [JeecgListMixin, mixinDevice],
    components: {
      CompanyRiskWasteModal
    },
    data() {
      return {
        description: '危废经营许可证管理页面',
        queryParam: {
        ...
        url: {
          list: "/risk/companyRiskWaste/list/" + this.listType,
          delete: "/risk/companyRiskWaste/delete",
          deleteBatch: "/risk/companyRiskWaste/deleteBatch",
          batchDeclare: "/risk/companyRiskWaste/batchDeclare",
        },
        dictOptions: {},
      }
    },
