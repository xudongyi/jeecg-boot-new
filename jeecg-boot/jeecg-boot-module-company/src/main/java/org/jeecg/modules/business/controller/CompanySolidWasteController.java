...
public class CompanySolidWasteController extends JeecgController<CompanySolidWaste, ICompanySolidWasteService> {
   ...
   public Result<?> add(@RequestBody CompanySolidWaste companySolidWaste) {
    ...
    public Result<?> declare(@RequestBody CompanySolidWaste companySolidWaste) {
   ...
   public Result<?> edit(@RequestBody CompanySolidWaste companySolidWaste) {
       CompanySolidWaste oldcompanySolidWaste = companySolidWasteService.getById(companySolidWaste.getId());
       //查询数据状态
