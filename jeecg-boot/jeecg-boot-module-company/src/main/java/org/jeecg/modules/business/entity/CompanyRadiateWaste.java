 ...
 */
@Data
@TableName("company_radiate_waste")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="company_radiate_waste对象", description="辐射许可证信息")
public class CompanyRadiateWaste implements Serializable {
	...
	/**辐射类别*/
	@Excel(name = "辐射类别", width = 15)
    @ApiModelProperty(value = "辐射类别")
