...
/**
 * @Description: 危废经营许可证信息
 * @Author: jeecg-boot
 * @Date:   2020-06-01
 * @Version: V1.0
 */
@Data
@TableName("company_risk_waste")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="company_risk_waste对象", description="危废经营许可证信息")
public class CompanyRiskWaste implements Serializable {
