...
public interface ICompanyComplaintLetterService extends IService<CompanyComplaintLetter> {
    ...
    Page<CompanyComplaintLetterVO> getCompanyComplaintLetter(Page<CompanyComplaintLetterVO> page, String companyIds, String status, Date dateBegin, Date dateEnd,Integer listType);
}
