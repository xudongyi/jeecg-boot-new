...
public class CompanyRadiateWasteController extends JeecgController<CompanyRadiateWaste, ICompanyRadiateWasteService> {
   ...
   public Result<?> add(@RequestBody CompanyRadiateWaste companyRadiateWaste) {
    ...
    public Result<?> declare(@RequestBody CompanyRadiateWaste companyRadiateWaste) {
   ...
   public Result<?> edit(@RequestBody CompanyRadiateWaste companyRadiateWaste) {
       CompanyRadiateWaste oldcompanyRadiateWaste = companyRadiateWasteService.getById(companyRadiateWaste.getId());
       //查询数据状态
