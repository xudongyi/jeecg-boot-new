...
@Data
public class AirqQuarterQualityVO {
    /*
    行政区域
     */
    ...
    /**年份*/
    @ExcelSelf(name = "年", width = 15,orderNum = 3)
    @ApiModelProperty(value = "year")
    private String year;
    @ExcelSelf(name = "季度", width = 15,orderNum = 4)
    @ApiModelProperty(value = "quarter")
    private String quarter;
    /**综合指数*/
    @ExcelSelf(name = "综合指数", width = 15,orderNum = 5)
    ...
    污染因子名称
     */
    @ExcelSelf(name = "污染因子名称", width = 15,orderNum = 6)
    private String meaning;
    /*
    等级1-6级
     */
    @ExcelSelf(name = "空气质量指数级别", width = 15,dicCode = "airLevel",orderNum = 7,dictType = SelfExcelConstants.ANNOTATION_DICT)
    private String airLevel;
    /**空气质量级别*/
    @ExcelSelf(name = "空气质量指数类别", width = 15,dicCode = "level",orderNum = 8,bgColor=true,dictType = SelfExcelConstants.ANNOTATION_DICT)
    @Dict(dicCode = "level")
    @ApiModelProperty(value = "空气质量级别")
    private String level;
    /**SO2*/
    @ExcelSelf(name = "二氧化硫(SO2)年平均浓度(μg/m3)", width = 20,orderNum = 9)
    @ApiModelProperty(value = "SO2")
    private Double a21026Avg;
    /**NO2*/
    @ExcelSelf(name = "二氧化氮(NO2)年平均浓度(μg/m3)", width = 20,orderNum = 10)
