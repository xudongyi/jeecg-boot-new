        ...
        <a-row>
          <a-col span='24'>
            <a-form-item label="许可证附件" :labelCol="labelCols" :wrapperCol="wrapperCols">
              <j-upload ref="uploadRef" :disabled="disableSubmit" fileType="file" bizPath="radiatewaste" @change="fileListChange" @delete ="fileDelete"
              ></j-upload>
            </a-form-item>
          </a-col>
        </a-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/radiate/companyRadiateWaste/add",
          edit: "/radiate/companyRadiateWaste/edit",
          declare: "/radiate/companyRadiateWaste/declare",
          queryFile:"/radiate/companyRadiateWaste/queryFiles"
        }
      }
    },
    created() {
