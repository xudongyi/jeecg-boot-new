<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      <a-table  v-if="this.operationShow"
        ref="table"
        size="middle"
        bordered
        rowKey="id"
    ...
    <companyAcceptance-modal ref="modalForm" @ok="modalFormOk" :companyId="companyId" @declare="reloadApply"></companyAcceptance-modal>
  </a-card>
</template>
