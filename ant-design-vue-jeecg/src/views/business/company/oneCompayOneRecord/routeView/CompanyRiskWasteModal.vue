        ...
        <a-row>
          <a-col span='24'>
            <a-form-item label="许可证附件" :labelCol="labelCols" :wrapperCol="wrapperCols">
              <j-upload ref="uploadRef" :disabled="disableSubmit" fileType="file" bizPath="riskwaste" @change="fileListChange" @delete ="fileDelete"
              ></j-upload>
            </a-form-item>
          </a-col>
        </a-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/risk/companyRiskWaste/add",
          edit: "/risk/companyRiskWaste/edit",
          declare: "/risk/companyRiskWaste/declare",
