<template>
  <div>
    ...
    <company-solid-waste-list v-if="listshow" :company-id="companyId" :operationShow="operationShow" :listType="listType" @reloadApply="reload"
    ></company-solid-waste-list>
...
<script>
  ...
  import CompanySolidWasteList from "../oneCompayOneRecord/routeView/CompanySolidWasteList";
