  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-dropdown v-if="selectedRowKeys.length > 0">
        ...
        <a-button style="margin-left: 8px"> 批量审核 <a-icon type="down" /></a-button>
      </a-dropdown>
    </div>
    ...
    <AirqHourAuditModal ref="modalForm" @ok="modalFormOk"></AirqHourAuditModal>
  </a-card>
</template>
...
<script>
  ...
  import AirqHourAuditModal from "./modules/AirqHourAuditModal";
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/hour/airqHour/queryAirqHourAudit",
          batchSubmit:"/hour/airqHour/batchSubmit",
          batchPass:"/hour/airqHour/batchPass",
          batchFail:"/hour/airqHour/batchFail",
